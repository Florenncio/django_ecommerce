...
class Category(MPTTModel):
    """
    Tabela das categorias do inventario.
    """
...
class Product(models.Model):
    """
    Tabelas com os detalhes dos produtos.
    """
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
        verbose_name=_("data product created"),
...
class Brand(models.Model):
    """
    Tabela com as marcas dos produtos.
    """
...
class ProductAttribute(models.Model):
    """
    Tabelas com os atributos dos produtos.
    """
...
class ProductType(models.Model):
    """
    Tabela com os tipos de produtos.
    """
...
class ProductAttributeValue(models.Model):
    """
    Tabela com os valores de atributo dos produtos.
    """
...
class ProductInventory(models.Model):
    """
    Tabela de produtos no inventario.
    """
    ...
    store_price = models.DecimalField(
        ...
        help_text=_("format: maximum price 999.99"),
        error_messages={"name": {"max_lenght": _("format: the price must be between 0 and 999.99.")}},
    )
    sale_price = models.DecimalField(
        ...
        help_text=_("format: maximum price 999.99"),
        error_messages={"name": {"max_lenght": _("the price must be between 0 and 999.99.")}},
    )
...
class Media(models.Model):
    ...
    is_feature = models.BooleanField(
        default=True, verbose_name=_("product visibility"), help_text=("format: default=false, true=default image")
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
        verbose_name=_("product visivility"),
    ...
    class Meta:
        ...
        verbose_name_plural = _("product imagens")


class Stock(models.Model):
    """
    Tabela com a quantidade de produtos em estoque.
    """
...
class ProductAttributeValues(models.Model):
    """
    Tabela com os links entre atributos e valores dos produtos.
    """
...
class ProductTypeAttribute(models.Model):
    """
    Tabela com os links entre tipos de produtos e seus atributos.
    """
